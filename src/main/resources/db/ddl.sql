...
create
type orderstatus as enum ('PREPARATION', 'CARGO', 'DELIVERED', 'CANCELED');
...
create
or
replace procedure sp_insert_city(city_name varchar(500))
    language plpgsql as
$$
begin
...
create or
replace procedure sp_activate_use_by_id(bigint, boolean)
language plpgsql
as $$
begin
update users
